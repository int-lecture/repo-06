...
<?php
	...
	*/
	...
	if($arrayNamen[0]==$user){
			echo" <h2><a href=chatten.php?user=".$user."&chatpartner=".$arrayNamen[1].">".$arrayNamen[1]."</a></h2>";	
		}elseif($arrayNamen[1]==$user){
			echo" <h2><a href=chatten.php?user=".$user."&chatpartner=".$arrayNamen[0].">".$arrayNamen[0]."</a></h2>";
		}
	}
